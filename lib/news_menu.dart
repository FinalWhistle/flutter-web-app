            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  const SizedBox(width: 17.0),
                  buildMenuItem(context, 'lib/assets/menu-logos/gaelic-menu.png', 'Gaelic', 'Gaelic'),
                  const SizedBox(width: 17.0),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushReplacement(
          context,
          PageRouteBuilder(
            pageBuilder: (context, animation, secondaryAnimation) => NewsFeedPage(selectedSport: sportName),
